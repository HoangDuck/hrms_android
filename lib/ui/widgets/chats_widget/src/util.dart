...
List<Object> calculateChatMessages(
  ...
  for (var i = messages.length - 1; i >= 0; i--) {
    ...
    final nextMessageHasCreatedAt = nextMessage != null ? nextMessage.createdAt != null : false;
    final nextMessageSameAuthor = nextMessage != null ? message.author.id == nextMessage.author.id : false;
    ...
    if (showUserNames) {
      ...
      final isFirstInGroup = notMyMessage &&
          ((previousMessage != null ? message.author.id != previousMessage.author.id : false) ||
              (messageHasCreatedAt &&
