...
import '../../flutter_chat_types/flutter_chat_types.dart' as types;
...
class Message extends StatelessWidget {
  ...
  final Widget Function(types.CustomMessage, {int messageWidth}) customMessageBuilder;
  ...
  final Widget Function(types.FileMessage, {int messageWidth}) fileMessageBuilder;

  /// Hide background for messages containing only emojis.
  final bool hideBackgroundOnEmojiMessages;

  /// Build an image message inside predefined bubble
  final Widget Function(types.ImageMessage, {int messageWidth}) imageMessageBuilder;
  ...
  final void Function(LongPressStartDetails details, types.Message) onMessageLongPressDetail;
        ...
        ? Container(
            ...
            child: GestureDetector(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: hasImage ? NetworkImage(message.author.imageUrl) : Image.asset(avatar_default).image,
                radius: 16,
                child: !hasImage
                    ? Text(
                        initials,
  ...
  Widget _statusBuilder(BuildContext context) {
    switch (message.status) {
      ...
      case types.Status.sent:
        return lastMessage ? InheritedChatTheme.of(context).theme.deliveredIcon != null
            ? InheritedChatTheme.of(context).theme.deliveredIcon
            : Image.asset(
                'images/chat_images/icon-delivered.png',
      ...
      case types.Status.error:
        return InheritedChatTheme.of(context).theme.errorIcon != null
            ...
            : Image.asset(
                'images/chat_images//icon-error.png',
                color: InheritedChatTheme.of(context).theme.errorColor
              );
      case types.Status.seen:
        return lastMessage ? InheritedChatTheme.of(context).theme.seenIcon != null
              ? InheritedChatTheme.of(context).theme.seenIcon
              : Image.asset('images/chat_images/icon-seen.png',
                  color: InheritedChatTheme.of(context).theme.primaryColor) : SizedBox();
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  ...
                  onLongPressStart: (detail) => onMessageLongPressDetail?.call(detail, message),
