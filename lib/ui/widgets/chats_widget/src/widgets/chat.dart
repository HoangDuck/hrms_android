...
class _ChatState extends State<Chat> {
  ...
  Widget _messageBuilder(Object object, BoxConstraints constraints, {bool lastIndex = false}) {
    if (object is DateHeader) {
      ...
      return Message(
        ...
        onMessageLongPressDetail: widget.onMessageLongPressDetail,
      ...
      child: InheritedChatTheme(
        ...
        child: InheritedL10n(
          ...
          child: Stack(
            children: [
              Container(
                color: Color(0xFFE7F3FF).withOpacity(0.5),
                child: Column(
                  children: [
                    Flexible(
                              ...
                              child: LayoutBuilder(
                                builder: (BuildContext context,
                                  ...
                                  itemBuilder: (item, index) =>
                                      _messageBuilder(item, constraints, lastIndex: index == 1),
                                  items: _chatMessages,
