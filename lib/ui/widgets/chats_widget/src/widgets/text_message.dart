...
import 'package:gsot_timekeeping/ui/widgets/chats_widget/flutter_link_previewer/flutter_link_previewer.dart'
      ...
      children: [
        ...
        if (!enlargeEmojis)
          SelectableText(
            ...
            style: user.id == message.author.id
                ? TextStyle(
                    color: neutral7.withOpacity(0.8),
                    fontSize: 10,
                    fontWeight: FontWeight.w500,
                    height: 1.5,
                  )
                : TextStyle(
                    color: neutral0.withOpacity(0.8),
                    fontSize: 10,
                    fontWeight: FontWeight.w500,
                    height: 1.5,
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(
        horizontal: _enlargeEmojis && hideBackgroundOnEmojiMessages ? 0.0 : _theme.messageInsetsHorizontal,
