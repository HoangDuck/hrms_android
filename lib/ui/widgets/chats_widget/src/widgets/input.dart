              ...
              child: Material(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: InheritedChatTheme.of(context).theme.inputBorderRadius,
                      border: Border.all(color: neutral0.withOpacity(0.5), width: 0.1)),
                  child: Row(
                    children: [
                      ...
                      if (widget.onImagePressed != null)
                        GestureDetector(
                          ...
                          child: Image.asset(
                            'images/chat_images/icon-file-input.png',
                            color: neutral0.withOpacity(0.5),
                            height: 24,
                            width: 24,
                          ),
                      ...
                      if (widget.onImagePressed != null)
                        GestureDetector(
                          ...
                          child: Image.asset(
                            'images/chat_images/icon-image-input.png',
                            color: neutral0.withOpacity(0.5),
                            height: 24,
                            width: 24,
                          ),
