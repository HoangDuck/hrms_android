...
abstract class ChatTheme {
  ...
  const ChatTheme({
     ...
     this.dateDividerMargin,
     this.dateDividerTextStyle,
     this.deliveredIcon,
     this.documentIcon,
     this.emptyChatPlaceholderTextStyle,
     this.errorColor,
     this.errorIcon,
    ...
    this.inputTextCursorColor,
     ...
     this.messageInsetsHorizontal,
     this.messageInsetsVertical,
     this.primaryColor,
     this.receivedEmojiMessageTextStyle,
     this.receivedMessageBodyTextStyle,
     ...
     this.sendButtonIcon,
     this.sendingIcon,
     this.sentEmojiMessageTextStyle,
     this.sentMessageBodyTextStyle,
     this.sentMessageCaptionTextStyle,
     this.sentMessageDocumentIconColor,
     this.sentMessageLinkDescriptionTextStyle,
     this.sentMessageLinkTitleTextStyle,
     this.statusIconPadding,
     this.userAvatarImageBackgroundColor,
     this.userAvatarNameColors,
     this.userAvatarTextStyle,
